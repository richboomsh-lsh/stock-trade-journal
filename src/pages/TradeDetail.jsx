...
function Section({ title, children }) {
  return (
    <div style={{
      ...
      <h3 style={{
        fontSize: '14px', fontWeight: 700, color: '#64748b', marginBottom: '16px',
    ...
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
        ...
        <button onClick={deleteTrade} style={{
          ...
          border: '1px solid #fca5a5', borderRadius: '8px', fontSize: '14px',
      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: '16px' }}>
          <div>
            <div style={{ fontSize: '12px', color: '#94a3b8', marginBottom: '4px' }}>종목명</div>
            <div style={{ fontSize: '22px', fontWeight: 700, color: '#1e293b' }}>{trade.stock_name}</div>
          ...
          {trade.profit_rate != null && (
            <>
              <div>
                ...
                <div style={{ fontSize: '28px', fontWeight: 700, color: getProfitColor(trade.profit_rate) }}>
                  {isProfit ? '+' : ''}{trade.profit_rate.toFixed(2)}%
                </div>
              </div>
              <div>
                <div style={{ fontSize: '12px', color: '#94a3b8', marginBottom: '4px' }}>수익금</div>
                <div style={{ fontSize: '20px', fontWeight: 700, color: getProfitColor(trade.profit_rate) }}>
